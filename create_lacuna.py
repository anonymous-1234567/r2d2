...
large_classes = meta[meta['Sample_Num']>=500]['Class_ID'].values.tolist() #list of class ids where the class has more than 500 

large_classes_exist = []
for _dir in large_classes: #for id in list of class ids
    try:
        os.listdir(os.path.join(train_data_root, _dir)) #if it's in the directory, add it to the list
